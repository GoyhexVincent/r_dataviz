...
setwd('/home/vgoyhex/local_server/r_dataviz/historicalurbanpopulationdata')
...
# import the csv data
modern <- read.csv2("modelskiModernV2.csv", header=T, sep="," ,stringsAsFactors=FALSE)
...
# import the csv data
ancient <- read.csv2("modelskiAncientV2.csv", header=T, sep="," ,stringsAsFactors=FALSE)
...
# import the csv data
chandler <- read.csv2("chandlerV2.csv",header=T, sep="," ,stringsAsFactors=FALSE)
